...
public class SurfingOrderBuilder extends AbstractOrderBuilder {

    @Override
    public void buildCompany() {
        List<AbstractCompany> companyList = new LinkedList<>();
        AbstractCompany lending =
                new Company("BOSC", "上海银行", "483432***43243");
        companyList.add(lending);
        AbstractCompany service =
                new Company("vcredit", "维信金科", "4325***423", "service");
        companyList.add(service);
    ...
    public void buildProduct() {
        ...
        AbstractCompany company =
                new Company("Orange", "橙分期", "234432***43243");
